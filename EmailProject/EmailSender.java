...
void sendEmail() throws MessagingException {
	String fromUser = "projectjavahit2021@gmail.com";
	String fromUserPassword ="Project@123";
...
MimeMessage draftEmail(String name, String gitlink, String mailid) throws AddressException,MessagingException {
	String emailSubject = "Rigestered Email Address Updated";
	String Signature = "<b style=\"color:red;\">Thanks & Regrads</b><br>Jio Team<br>";
			
//	String emailBody="Hi "+name+"<br><br>To know more of your account:"+"<a.href="+gitlink+"/>"+gitlink+"</a><br><br>"+Signature;
	String emailBody="Dear Customer,<br><br>Registered email address for your Jio Number has been linked to "+name+"@gmail.com as per your request.The new email address will now be your Jio ID.\r\n <br><br>To manage your account with MyJio app, click https://www.jio.com/GetMyJio"+"</a><br><br>"+Signature;
